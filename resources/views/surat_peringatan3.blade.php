...
<body>
    ...
    <div class="container">
        ...
        <div class="main-content">
            ...
            <ol>
                <li>{{$surat1}} (kedua) tersebut belum menjadi perhatian Saudara.</li>
                <li>Akibat kelalaian Saudara maka tunggakan Saudara sampai dengan tanggal {{ \Carbon\Carbon::parse($surat->tanggal_surat)->isoFormat('D MMMM YYYY') }} telah berjumlah sebagai berikut:</li>
            </ol>
            ...
            <ol start="3">
                <li>
                Kepada Saudara kami beri kesempatan terakhir untuk melunasi semua tunggakan tersebut paling lambat 15 (lima belas) hari sejak tanggal surat ini, apabila sampai batas waktu tersebut belum juga dilunasi maka penyelesaian kredit Saudara dilakukan melalui saluran hukum yang berlaku atau pelelangan terhadap agunan yang telah Saudara serahkan kepada kami.
                </li>
             </ol>

            <p>Demikian disampaikan, atas perhatian Saudara yang sungguh-sungguh kami ucapkan terima kasih.</p> </div>
        </div>
