...
<html lang="en">
  <head>
    ...
    {{-- Jika Anda menggunakan Bootstrap JS Bundle, jQuery mungkin sudah termasuk atau tidak diperlukan terpisah, tergantung versi Bootstrap --}}
    {{-- Contoh Bootstrap 5 Bundle (tidak termasuk jQuery, tapi jQuery mungkin tidak diperlukan untuk semua komponennya) --}}
    {{-- <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ka7Sk0Gln4gmtz2MlQnikT1wXgYsOg+OMhuP+IlRH9sENBO0LRn5q+8nbTov4+1p" crossorigin="anonymous"></script> --}}
    <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/1.13.6/css/jquery.dataTables.min.css">
    {{-- Opsional: Styling untuk Bootstrap 5 (jika Anda menggunakan Bootstrap 5) --}}
  ...
  <body class="antialiased text-gray-800" style="background-color: white">
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
          <a class="navbar-brand brand-logo" href="index.html"><img style="height: 50px" src="{{asset('template/dist/assets/images/bank_nagari.png')}}" alt="logo" /></a>
    ...
    <script src="https://cdn.datatables.net/1.13.6/js/jquery.dataTables.min.js"></script>
        ...
        {{-- Dependencies for Excel and PDF export --}}
        <script src="https://cdnjs.cloudflare.com/ajax/libs/jszip/3.10.1/jszip.min.js"></script>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.2.7/pdfmake.min.js"></script>
        <script src="https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.2.7/vfs_fonts.js"></script>
    {{-- Opsional: Integrasi dengan Bootstrap 5 (jika Anda menggunakan Bootstrap 5) --}}
